# Generated by Django 4.0.5 on 2022-08-01 01:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_type', models.CharField(choices=[('Simples', 'Simples'), ('Perecível', 'Perecível'), ('Alto Valor', 'Alto Valor'), ('Frágil', 'Frágil'), ('Perigosa', 'Perigosa'), ('Pesado', 'Pesado'), ('Refrigerada', 'Refrigerada')], default='Simples', max_length=15)),
                ...
                ('user_transporter', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_transporter', to=settings.AUTH_USER_MODEL)),
